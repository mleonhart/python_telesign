...
class PhoneId(ServiceBase):
    ...
    def call_forward(self, phone_number, use_case_code):
        """
        In addition to the information retrieved by **standard**, this service provides call forward detection data associated with the specified phone number.
